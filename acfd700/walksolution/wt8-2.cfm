...
<title>Walkthrough 8-2: Flash Form Layout</title>
</head>
...
<cfform  format="flash" width="#formwidth#" height="400" id="flashform">
	...
	<cfformgroup type="tabnavigator">
		...
		<!--- page 1 content --->
		<cfformgroup type="page" label="Name/Teaser" height="300" width="#variables.formwidth#">
		...
		<!--- page 2 content --->
		<cfformgroup type="page" label="Full Text" height="300" width="#variables.formwidth#">
		...
		<!--- page 3 content --->
		<cfformgroup type="page" label="Publishing Options" height="300" width="#variables.formwidth#">
		...
		</cfformgroup> <!--- horizontal layout for date/time --->	
