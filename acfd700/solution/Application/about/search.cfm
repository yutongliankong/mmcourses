...
<div style="font-family: arial; font-size: 10px;">
	...
	<cfif isdefined("form.btnSubmit")>
		...
		<cfif form.searchtype is 0><!--- google search --->
				...
				<!--- lab 11 starts here --->
				<cfobject component="#application.cfcpath#search" name="cfcSearch">
		...
		<cfelse> <!--- verity search --->
			...
			<cfinvoke 
				webservice = "http://#cgi.SERVER_NAME#:#cgi.server_port#/mmcourses/acfd700/solution/components/search.cfc?wsdl"
				method="veritysearch"
				returnvariable = "aResults">
				
				<cfinvokeargument  name="searchquery" value="#form.searchterms#">
