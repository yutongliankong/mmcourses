...
<link href="#request.basehref#style/cafetownsend.css" rel="stylesheet" type="text/css">
</head>
<body bgcolor="##000000">

  <table width="700" border="0" cellpadding="0" cellspacing="0">
    <tr>
    <td><img src="#request.basehref#images/header.jpg"></td>
  </tr>

  <tr>
      <td><img src="#request.basehref#images/body_main_header.gif" width="700" height="25"></td>
  </tr>
  </table>
  <table width="700" border="0" cellpadding="0" cellspacing="0">
  <tr>
	  ...
	  <td bgcolor="##F7EEDF" width="230" align="center" valign="top">
        ...
        <img src="#request.basehref#images/street_sign.jpg" width="202" height="136" hspace="0" vspace="12" border="0">
	  </td>
  ...
  <table width="700" border="0" cellpadding="0" cellspacing="0">
  <tr>
      <td><img src="#request.basehref#images/body_main_footer.gif" width="700" height="25"></td>
  </tr>
</table>
