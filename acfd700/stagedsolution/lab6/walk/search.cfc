	...
	<cffunction name="googleSearch" access="public" returntype="array" output="false">
		...
		<cfinvoke 
			...
			method="doGoogleSearch"
	 		returnvariable="objGoogleSearchResult" timeout="10">
		...
		<cfcatch type="application">
			<cfthrow 	type="cafetownsend.search.googlesearch.init"
						message="Failed to contact Google"
						detail="#cfcatch.message#:#cfcatch.detail#">
		</cfcatch>
		<cfcatch type="timeout">
			<cfthrow	type="cafetownsend.search.googlesearch.timeout"
						message="Google Web Service took too long to respond"
						detail="#cfcatch.message#:#cfcatch.detail#">
		</cfcatch>
		</cftry>
		...
		<cftry>
			...
			<cfcatch type="Object">
				<cfthrow 	type="cafetownsend.search.googlesearch.methodinvocation"
							message="Google methods returned unexpected results"
							detail="#cfcatch.message#:#cfcatch.detail#">
			</cfcatch>
		</cftry>
		<cfreturn aData>
